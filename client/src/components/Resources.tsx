        ...
        <section id="resources" className="py-14 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                                ...
                                <div className="mt-6">
                                    <Link
                                        ...
                                        className="inline-flex items-center text-orange-600 hover:text-gray-600 transition-colors"
                                    >
                                        Read full article
                ...
                <div className="mt-12 text-center">
                    <Link
                        to="/resources"
                        className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-orange-600 hover:bg-gray-600 transition-colors duration-300"
                    >
                        View All Resources
